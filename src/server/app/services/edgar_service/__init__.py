...
class EdgarService:
    ...
    def getEntityFilingHistory(tenDigitCIK):
    ...
    # Get Company Facts
    def getCompanyFacts(tenDigitCIK):
    ...
    def getRssFeed(tenDigitCIK, formType):
    ...
    def getRecentFilings(formType, companyName, cik):
